...
root_paths=("./data/Security")
data_paths=("US_FEMAGrant_Month.csv") 
pred_lengths=(12)
seeds=(2021)
use_fullmodel=0
length=${#root_paths[@]}
    ...
    do
      ...
      do
        ...
        python -u run.py \
          ...
          --root_path $root_path \
          --data_path $data_path \
          --model_id ${model_id}_gnn__${seed}_24_${pred_len}_fullLLM_${use_fullmodel} \
          --model $model_name \
          --data custom \
          --features M \
          --seq_len 8 \
          ...
          --prompt_weight 0.1 \
          --pool_type "avg" \
          --save_name "result_security_bert_gnn" \
          --llm_model BERT \
