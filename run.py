...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_gnn', type=int, help='gnn', default=1)
    parser.add_argument('--alpha', type=float, help='weight for multi-loss', default=1e-3)
    ...
    parser.add_argument('--learning_rate4', type=float, default=1e-4, help='gnn learning rate')
